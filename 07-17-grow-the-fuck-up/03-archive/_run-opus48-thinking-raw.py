...
open('/home/ubuntu/music/07-17-grow-the-fuck-up/opus48-thinking-xhigh-raw-stdout.txt', 'w').write(result.stdout or '')
open('/home/ubuntu/music/07-17-grow-the-fuck-up/opus48-thinking-xhigh-raw-stderr.txt', 'w').write(result.stderr or '')
